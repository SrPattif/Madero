...
<head>
    ...
    <title>Arquivos de Condomínio | Controladoria Grupo Madero</title>
            ...
            <div class="card">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><?php echo($row['nome_interno']); ?></td>
                        <td><a href="/moradias/reembolsos/alojamentos/detalhes/?id_alojamento=<?php echo($row['id_alojamento']); ?>"
                        ...
                        <td>
                            <div class="file-options">
                                ...
                                <div class="option">
                                    <a href="/moradias/reembolsos/alojamentos/detalhes/?id_alojamento=<?php echo($row['id_alojamento']); ?>"
                                        target="_blank"><span data-tooltip="Detalhes da Moradia" data-flow="left"
                                            style="text-align: center; z-index: 999;"><i
