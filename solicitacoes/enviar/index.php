...
<body>
    ...
    <main>
        <div class="page-content">
            ...
            <div class="double-buttons">
                <div class="simple-button">FECHAR</div>
                <div class="button">MARCAR COMO ENVIADO</div>
                <div class="button">MARCAR COMO ENVIADO E PROSSEGUIR</div>
            </div>
        </div>
    </main>
    ...
    function downloadEmail() {
        ...
        if (qtdeContatos <= 0) {
            ...
            $.ajax({
                url: '../../backend/geradorSolicitacao.php?id_moradia=<?php echo((int) $houseData['id']); ?>', // Caminho para o arquivo PHP que retorna as colunas
                type: 'GET',
                dataType: 'json',
